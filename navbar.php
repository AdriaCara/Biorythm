                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link <?php echo $activeInfo ?>" href="Info.php?lenguage=<?php echo $lenguage; ?>"><?php echo $currentLenguage[6]; ?></a>
                                </li> 
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="?lenguage=english"><?php echo $currentLenguage[8];?></a></li>
                                        <li><a class="dropdown-item" href="?lenguage=spanish"><?php echo $currentLenguage[9];?></a></li>
                                        <li><a class="dropdown-item" href="?lenguage=catalan"><?php echo $currentLenguage[10];?></a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
